...
from troposphere.batch import (ComputeEnvironment, ComputeEnvironmentOrder,
                               ComputeResources, ContainerProperties,
                               FargatePlatformConfiguration, JobDefinition,
                               JobQueue, LogConfiguration,
                               NetworkConfiguration, ResourceRequirement,
...
t = Template(Description="Setup cron jobs with a job queue and send slack message when a job fails.")
